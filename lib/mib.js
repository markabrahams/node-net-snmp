        ...
        Serialize: function () {
            ...
            for (var FileName in Table) {
                ...
                if (!foundTheEnd) {
                    ...
                    console.warn('The contents of module [%s] are malformed: no END statement found\n\tLast known good declaration:\t%s (line %s)', ModuleName, lastGoodDeclaration.join(' '), lastGoodDeclaration.line);
                }
